...
| 2 | `AGENTS.md` raiz | Instrucciones locales de tooling para este repo, si aplican |
| 3 | `OPERACION/CONTEXT_ROUTER.md` | Router de contexto |
| 4 | `PROJECT_BLUEPRINT/` | Plano documental para entender estructura de proyecto |
| 5 | `PROJECT_TEMPLATE/` | Molde estructural, no verdad operativa |
...
| 10 | `PROJECT_TEMPLATE/` | Formato, no verdad |
