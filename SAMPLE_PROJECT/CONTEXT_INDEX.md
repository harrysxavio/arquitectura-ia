...
|---|---|---|
| Primer contacto | `README.md` | Entrada rapida para humanos. |
| Identidad y alcance | `PROJECT_GUIDE.md` | Que es y que no es el ejemplo. |
| Reglas locales de agentes | `AGENTS.md` | Como operar agentes dentro del ejemplo. |
...
| Tareas del cambio | `openspec/changes/add-security-priority/tasks.md` | Lista ejecutable. |
...
| Datos de ejecucion | `data/requests.json` | Datos locales de ejecucion, no canonicos. |
